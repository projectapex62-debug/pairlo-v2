...
import { featuredPairs, destinations, stats, howItWorks, testimonials, allPairs, travelExperts } from "../lib/mock-data";
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "64px", textAlign: "center" }}>
            ...
            <p style={{
              ...
              Every pair on Pairlo is reviewed by a travel specialist who has
              driven the roads, slept in the beds, and knows the difference.
            </p>
          </div>
          ...
          <div style={{
            ...
            {travelExperts.map((expert, i) => (
              <div
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLDivElement).style.boxShadow = "0 8px 32px rgba(123,91,58,0.12)";
              ...
              >
                ...
                <div style={{
                  ...
                  borderRadius: "50%",
                  overflow: "hidden",
                  border: "3px solid var(--color-mocha)",
                  marginBottom: "20px",
                  flexShrink: 0,
                }}>
                  <img
                ...
                <div style={{
                  ...
                  <div>
                    <p style={{ fontFamily: "var(--font-display)", fontSize: "20px", fontWeight: 500, color: "var(--color-black)" }}>
                      {expert.trips.toLocaleString()}
                    </p>
                    <p style={{ fontFamily: "var(--font-body)", fontSize: "11px", color: "var(--color-gray-500)", textTransform: "uppercase", letterSpacing: "0.08em" }}>
                      Trips
                    </p>
                  </div>
                ...
                <div style={{
                  ...
                  {expert.specialties.map((s, j) => (
                    <span key={j} style={{
                      ...
                      border: "1px solid rgba(123,91,58,0.18)",
                      borderRadius: "100px",
                      padding: "3px 10px",
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    Top destination: <strong style={{ color: "var(--color-black)", fontWeight: 600 }}>{expert.topDestination}</strong>
                  </span>
                </div>
              </div>
            ))}
